...
#define NSBOOT_CONFIG_SIZE   ${NSBOOT_CONFIG_SIZE}
#define NSBOOT_MSC_START     ${NSBOOT_MSC_START}
...
#define SG_BOOTPATH_NEEDED_START_ROUNDUP_32 ${SG_BOOTPATH_NEEDED_START_ROUNDUP_32}

#define CPACR_OFFSET           ${CPACR_OFFSET}
#define TT_VALUE_OFFSET        ${TT_VALUE_OFFSET}
#define ALWAYS_POINTER_OFFSET  ${ALWAYS_POINTER_OFFSET}
#define PARTITION_TABLE_POINTER_OFFSET  ${PARTITION_TABLE_POINTER_OFFSET}
#define MSC_POINTER_OFFSET     ${MSC_POINTER_OFFSET}
